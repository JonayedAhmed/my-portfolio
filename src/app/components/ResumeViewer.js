...
export default function ResumeViewer({ src }) {
    ...
    return (
        <div className="relative max-w-4xl mx-auto">
            {/* ambient glows */}
            <div className="pointer-events-none absolute -top-16 -left-16 h-72 w-72 rounded-full bg-accent/10 blur-3xl" />
            <div className="pointer-events-none absolute -bottom-16 -right-16 h-72 w-72 rounded-full bg-lightest-navy/40 blur-3xl" />
